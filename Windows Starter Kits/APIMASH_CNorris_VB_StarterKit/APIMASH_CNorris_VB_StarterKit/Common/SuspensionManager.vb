...
Friend NotInheritable Class SuspensionManager
    ...
    Public Shared Async Function SaveAsync() As Task
        Try
            ...
            For Each weakFrameReference As Object In _registeredFrames
                Dim frame As Frame
    ...
    Public Shared Sub UnregisterFrame(frame As Frame)
        ...
        _registeredFrames.RemoveAll(Function(weakFrameReference)
                                        Dim testFrame As Frame
                                        Return Not weakFrameReference.TryGetTarget(testFrame) OrElse (testFrame.GetHashCode() = frame.GetHashCode())

                                    End Function)
        '' function return was OrElse testFrame = frame - dcn
    End Sub
